...
#define LDR_DLL_NAME	"zt_moco.dll"
...
#	if defined(ZT_LOADER)
	zt_consoleAddCommand("build", "Compiles the DLL", ldr_buildDllConsoleCommand_FunctionID, ztInvalidID);
#	endif
